...
function door () {
    do {
        if (user.door === false) {
            console.log("Tu n'as pas la clé pour ouvrir cette porte, retourne chercher dans la salle !");
        }else {
...
function codeObject () {
    do {
        if (user.codeObject === false) {
            console.log("Le code que tu recherches n'es pas là, retourne chercher dans la salle !");
        }else {
            console.log("Super, enfin dans tu as le code pour aller désamorcer l'alarme !");
...
function hammer () {
    do {
     if (user.hammer === false) {
         ...
         console.log("Super, tu peux aller briser la vitrine pour récupérer le costume");
         user.hammer === true;
...
function breakGlaces () {
    do {
     if (user.hammer === false) {
         console.log("Hé non, tu n'as pas le marteau pour casser la vitrine, trouves le !");
     }else {
